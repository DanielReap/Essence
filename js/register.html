    ...
    <body>
        ...
        <div class="container">
            <form class="form-signin">
                ...
                <input type="password2" id="inputPassword" class="form-control" placeholder="Repeat Password" required>
                <button class="btn btn-lg btn-signup btn-block" type="submit">Register</button>
            </form>
        </div>
